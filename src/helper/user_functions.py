...
# def user_staking_rewards():
#     staking_rewards = info.user_staking_rewards(id)
#     # print(staking_rewards)
#     rewards = Rewards.model_validate(staking_rewards).root
#     modified_rewards = [
#         {"time": r.time, "total aamount": r.totalAmount, "source": r.source}
#         for r in rewards
#     ]
#     print(modified_rewards)
